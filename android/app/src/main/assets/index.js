...
exports.default = new _vueRouter2.default({
  // mode: 'history',
  routes: [{ path: '/login', component: _Login2.default }, { path: '/', redirect: '/login' }]
});
...
__vue_options__.__file = "G:\\graduation\\green-music-frontend\\src\\App.vue"
...
__vue_options__.__file = "G:\\graduation\\green-music-frontend\\src\\views\\Login.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-03d55004"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    focusUsername: function focusUsername() {
      modal.toast({ message: 'username focus', duration: 1 });
      this.usernameFocus = true;
    },
    blurUsername: function blurUsername() {
      this.usernameFocus = false;
    },
    focusPassword: function focusPassword() {
      this.passwordFocus = true;
    },
    blurPassword: function blurPassword() {
      this.passwordFocus = false;
    },
    moveUpTexts: function moveUpTexts() {
      var textsEl = this.$refs.texts;
      var contentEl = this.$refs.content;
      var regEl = this.$refs.reg;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Green Music")]), _c('text', {
    staticClass: ["sub-title"]
  }, [_vm._v("Welcome back")]), _c('text', {
    staticClass: ["tir-title"]
  }, [_vm._v("Sign in to continue to Green Muisc")])]), _c('div', {
    ref: "content",
    staticClass: ["content"]
  }, [_c('div', {
    staticClass: ["form-group"]
  }, [_c('input', {
    staticClass: ["form-group-username", "form-group-input"],
    attrs: {
      "type": "text",
    ...
    on: {
      "focus": _vm.focusUsername,
      "blur": _vm.blurUsername,
    ...
    class: {
      'form-group-line': true, 'form-group-line-active': _vm.usernameFocus
    }
  }), _c('input', {
    staticClass: ["form-group-password", "form-group-input"],
    attrs: {
      "type": "password",
    ...
    on: {
      "focus": _vm.focusPassword,
      "blur": _vm.blurPassword,
      "input": function($event) {
    ...
    class: {
      'form-group-line': true, 'form-group-line-active': _vm.passwordFocus
    }
  }), _c('div', {
    staticClass: ["form-group-btn"]
  }, [_c('text', {
    class: {
      'form-group-btn-text': true, 'form-group-btn-text-active': _vm.username && _vm.password
    },
    on: {
      "click": _vm.login
    }
    ...
    ref: "reg",
    staticClass: ["reg"]
  }, [_c('text', [_vm._v(_vm._s(_vm.username) + "-" + _vm._s(_vm.usernameFocus))]), _c('text', {
    staticClass: ["reg-link"]
  }, [_vm._v("还没有账户？点此注册")])])])
},staticRenderFns: []}
